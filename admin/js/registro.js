const nombreCompleto = document.getElementById('nombreAdmin')
const email = document.getElementById('emailAdmin')
const password = document.getElementById('passwordAdmin')
const repassword = document.getElementById('repasswordAdmin')
const region = document.getElementById('regionAdmin')
const comuna = document.getElementById('comunaAdmin')
